...
% the least amount of artifacts, compared to lower resolution. The estimated trajectory followed accurately the 
% ground-truth trajectory. There were no constant offsets on either axes. The RMS error was 8.12cm on the x- and 
...
For the 4x4-resolution 400ms sampling time was chosen, based on the real sensor measurements.  The dropped sampling rate 
...
ranges are in saturation. Low grid resolution produced a smoother path, while on high-resolution grid there 
were some edges and sharper turns. High resolution felt less stable, than the low-resolution grid.
