...
Especially turns around the vertical axis. The usage of 13 LIDAR sensors just for 2D scanning would mean a lot of overhead when 
...
\section{Google Cartographer 3D SLAM}