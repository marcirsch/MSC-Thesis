...
and not furnished, but has details like columns and curves so Cartographer can match scans more 
efficiently. SLAM will not work properly on a corridor with undetailed walls, because it needs 
a reference point. If each scan looks exactly the same the algorithm will lose track.
