\chapter{Components review} \label{chap:components}
...
can be used on a real quadcopter with little or no modifications. As for communication of the software components
