...
\newcommand{\vikszerzoVezeteknev}{Rausch}
...
\newcommand{\vikcim}{Drone Localization in Ad-hoc Indoor Environment} % Cím
\newcommand{\viktanszek}{\bmemit} % Tanszék
\newcommand{\vikdoktipus}{\msc} % Dokumentum típusa (\bsc vagy \msc)
\newcommand{\vikmunkatipusat}{diplomamunkát} % a "hallgató nyilatkozat" részhez: szakdolgozatot vagy diplomatervet
...
\include{content/simulation}
\include{content/system_design}
\include{content/implementation}
% \include{content/futureUse}
...
\bibliography{C:/repos/diploma/src/bib/mybib.bib}
